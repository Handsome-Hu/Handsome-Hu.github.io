...
date: 2022-02-17 09:37:34
permalink: /pages/aadc95/
categories:
  - JavaScript
  - JavaScript高级
tags:
...
熟悉Java的小伙伴应该对面向对象编程不陌生。面向对象不是新的东西，它只是过程式代码的一种高度封装，目的在于提高代码的开发效率和可维护性。
...
这样封装确实爽多了，通过工厂模式我们解决了创建多个相似对象代码冗余的问题，但还有一个问题没有解决。

如果你打印`p1`和`p2`会发现他们都是`Object`类型，这样就无法将他们同其它对象区分开来，那怎样知道一个对象的类型呢？
...
下一小节，我们将学习使用 `prototype`原型对象解决构造函数的问题。